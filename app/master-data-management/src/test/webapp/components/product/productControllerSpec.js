...
//            $httpBackend.when('GET', '/data/stores/guid').respond(responseStoreGuids);
//            $httpBackend.when('GET', '/data/products/productNumberOrName/:searchString').respond(responseFindAllProducts);
//            $httpBackend.when('GET', '/data/adminProducts/highestProductNumberProduct').respond(responseFindOneProduct);
...
//                    spyOn(productService, "save").and.callFake(function () {
//                        deferred = $q.defer();
//                        deferred.$promise = deferred.promise;
//                        deferred.resolve("Result");
//                        return deferred;
//                    });
//                    spyOn(productService, "findAll").and.callFake(function () {
//                        return responseFindAllProducts;
//                    })
//                });
//                spyOn($scope, "resetForm").and.callFake(function() {});
//                spyOn(ctrl, "makeProductEditorInvisible").and.callFake(function() {});
//                $scope.product.number = 1;
//                $scope.saveProduct();
//                $rootScope.$digest();
//                expect($scope.gridOptions.data.length).toBe(2);
//                expect($scope.product.number).toBe(1);
//            });
//
...
//
//                ctrl.setNextProductNumber = function() {};
//
//                inject(function(productService) {
//                    spyOn(productService, "deleteByProductNumber").and.callFake(function() {
...
//            });
//
//            it('should set the next product Number', function() {
//                inject(function(productService) {
//                    spyOn(productService, 'getNextValidProductNumber').and.callFake(function() {
//                        var deferred = $q.defer();
//                        deferred.resolve(responseNextProductNumber);
//                        deferred.$promise = deferred.promise;
//                        return deferred;
//                    })
//                });
//                ctrl.setNextProductNumber();
//
//                $rootScope.$digest();
//
//                expect($scope.product.number).toBe(2);
//                expect(ctrl.defaultProduct.number).toBe(2)
//            });
//
//            it('should call updateUiGridDataFromDatabase', function() {
//                inject(function(productService) {
//                    spyOn(productService, 'findAll').and.callFake(function() {
//                        var deferred = $q.defer();
//                        deferred.resolve(responseFindAllProducts)
//                        deferred.$promise = deferred.promise;
//                        return deferred;
//                    })
//                });
//
//                ctrl.updateUiGridDataFromDatabase();
//                $rootScope.$digest();
//                expect($scope.gridOptions.data.length).toBe(0);
//            });
//
//            it('should clear all Selections and reset the Form', function() {
//                $scope.gridApi = {
//                    selection: {
//                        clearSelectedRows: function() {}
//                    }
//                }
//                spyOn(ctrl, 'removeUiGridSelectionColor').and.callFake(function() {});
//                spyOn(ctrl, 'setNextProductNumber').and.callFake(function() {});
//
//                $scope.resetForm();
//
...
//
//                inject(function(productService) {
//                    spyOn(productService, 'checkIfResourceInstance').and.callFake(function() {
//                        return true;
//                    });
//                    spyOn(productService, 'update').and.callFake(function() {
//                        var deferred = $q.defer();
//                        deferred.$promise = deferred.promise;
//                    })
//                });
//
//                $scope.saveRow(responseFindOneProduct);
//                $rootScope.$digest();
//
//                expect($scope.gridApi.rowEdit).toBeDefined();
//            });
//        });
//    });
//});
