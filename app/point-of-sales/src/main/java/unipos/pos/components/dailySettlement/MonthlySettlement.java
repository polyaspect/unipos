...
@Document(collection = "monthlySettlements")
@Data
@Builder
public class MonthlySettlement implements Syncable {
    ...
    public MonthlySettlement(String id, LocalDateTime dateTime, boolean closed, String storeGuid, String deviceId, String guid) {
        this.id = id;
