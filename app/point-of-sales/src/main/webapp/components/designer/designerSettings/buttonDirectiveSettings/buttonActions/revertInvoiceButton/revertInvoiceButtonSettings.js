...
define([
    'angular',
    'pos.linq',
    'css!pos.designer.designerSettings.buttonDirectiveSettings.revertInvoiceButtonSettings'
], function (angular) {
    return ['$rootScope', 'pos.initOptions', 'pos.designer.screenService', 'pos.designer.styleService', function (rootScope, initOptions, screenService, styleService) {
        return {
            restrict: 'E',
            replace: true,
            templateUrl: initOptions.baseDir + 'components/designer/designerSettings/buttonDirectiveSettings/buttonActions/revertInvoiceButton/revertInvoiceButtonSettings.html',
            link: function (scope, el, attrs) {
                if (scope.modelOptions.showDesignFirst) {
                    scope.activeTab = 1;
                }
                scope.model = {};
                scope.parentCss = styleService.getGlobalCssData().button.data.revertInvoiceFunction.data || {};
                ...
                scope.save = function () {
                    ...
                    reversalButtonConfig.data.serviceName = "pos.revertInvoiceButtonService";
