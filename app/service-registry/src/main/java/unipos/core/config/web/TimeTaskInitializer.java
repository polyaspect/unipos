...
import unipos.core.components.timeTask.TimeTaskService;
import unipos.core.special.StoreRepository;
...
public class TimeTaskInitializer {
    ...
    public void initTimeTasks() throws SchedulerException {
        ...
        stores.forEach(store -> timeTaskService.scheduleAutoUpdate(store));
